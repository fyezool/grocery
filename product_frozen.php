...
$result = $db->query("SELECT pro_name, pro_price, pro_mem_price, pro_description, quantity FROM products WHERE pro_type like 'Frozen Food';");
?>
    ...
    <div class="content">
      ...
      <div id="gallery">
        ...
        <tr style="background-color : #BEDCD9;">
          <td>Product Name</td>
          <td>Product Price</td>
          <td>Product Price for Members</td>
