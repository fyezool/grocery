...
if(isset($_POST['submit']))
{
	...
	if(!isset($error))
	{
		...
		try
		{
			...
			$stmt = $db->prepare('INSERT INTO Feedback (fb_name,fb_contact,fb_email,comment) VALUES (:name, :contact, :email, :comment)');
			$stmt->execute(array(
				':name' => $_POST['name'],
			...
			header('Location: feedback.php?action=joined');
			exit;
			...
			<div class="row">
			    ...
			    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
					<form role="form" method="post" action="" autocomplete="off">
						...
						<div class="form-group">
							<textarea name="comment" rows="5" id="comment" class="form-control input-lg" placeholder="Customer Comment" value="<?php if(isset($error)){ echo $_POST['comment']; } ?>" tabindex="1"></textarea>
						</div>
						<div class="row">
