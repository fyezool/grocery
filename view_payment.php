...
$result = $db->query("SELECT payments.order_id, payments.pay_date, products.pro_name, payments.quantity, payments.pro_price, payments.totalPrice, employees.emp_name FROM payments
  INNER JOIN products ON payments.pro_id = products.pro_id INNER JOIN employees on payments.emp_id = employees.emp_id");
?>
